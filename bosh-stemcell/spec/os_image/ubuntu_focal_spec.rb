...
describe 'Ubuntu 20.04 OS image', os_image: true do
  ...
  describe 'base_apt' do
    describe file('/etc/apt/sources.list') do
      its(:content) { should match 'deb http://archive.ubuntu.com/ubuntu focal main universe multiverse' }
      its(:content) { should match 'deb http://archive.ubuntu.com/ubuntu focal-updates main universe multiverse' }
      its(:content) { should match 'deb http://security.ubuntu.com/ubuntu focal-security main universe multiverse' }
    end
...
_chrony:x:108:113:Chrony daemon,,,:/var/lib/chrony:/usr/sbin/nologin
